...
import ErrorPage from "./components/ErrorPage.jsx"; // Import ErrorPage


const router = createBrowserRouter(
  createRoutesFromElements(
    <>
      <Route path="/admin" element={<App />} errorElement={<ErrorPage />}>
        ...
        <Route path="*" element={<ErrorPage />} /> {/* Catch all 404s */}
      </Route>
    </>
  )
);
